...
The exec_handler function sets the file redirects according to the flags set in main, and then executes the entered command if
it is a valid command. The command may be entered as a background command by passing & as the final argument, or it will run in
